...
export default function TrendingProduct() {
    ...
    useEffect(() => {
        ...
        async function loadTrendingSectionImage() {
            try {
                ...
                if (!ignore && typeof image === 'string' && image) {
                    setTrendingImage(image);
                }
            } catch {
                // keep default
            }
    ...
    const resolvedTrendingBg = trendingImage || '';

    return (
        <FadeInOutOnView
            as="section"
            className="relative w-full overflow-hidden bg-[#f4f2ed] py-16"
        ...
        >
            {resolvedTrendingBg ? (
                <div
                    ...
                    style={{
                        opacity: 0.55,
                        backgroundImage: `url(${resolvedTrendingBg})`,
            ...
            <h3 className="mb-12 text-center font-serif text-4xl text-zinc-900 text-white">
                Trending Products
            </h3>
