...
export default function AboutPage() {
    ...
    useEffect(() => {
        function handleBuilderMessage(event) {
            ...
            if (!data || data.type !== 'TIMLESS_PAGE_BUILDER_SCROLL_TO_SECTION') return;
    ...
    const deferSections = !isBuilderPreview;
    ...
    return (
        <div className="bg-background">
            ...
            <div id="section-1971-about">
                <LazySection heightClass="h-[520px]" variant="split" defer={deferSections}>
                    <About1971Section />
                </LazySection>
            </div>

            <div id="section-sustainability">
                <LazySection heightClass="h-[560px]" variant="split" defer={deferSections}>
