...
class ProductController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'thumbnail_image' => 'nullable|image|mimes:jpeg,jpg,png,webp',
            'size_chart_image_file' => 'nullable|image|mimes:jpeg,jpg,png,webp',
            'size_chart_files' => 'nullable|array',
            'size_chart_files.*' => 'image|mimes:jpeg,jpg,png,webp',
            'image_gallery' => 'nullable|array',
            'image_gallery.*' => 'image|mimes:jpeg,jpg,png,webp',
